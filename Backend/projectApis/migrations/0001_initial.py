    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('domain', models.CharField(blank=True, default='', help_text='Project domain (e.g., E-commerce, Healthcare, Finance)', max_length=100)),
                ('tech_stack', models.JSONField(blank=True, default=list, help_text="Technology stack (e.g., ['React', 'Django', 'PostgreSQL'])")),
                ('deadline', models.DateField(blank=True, help_text='Project deadline for AI task prioritization', null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('llm_task_id', models.CharField(blank=True, db_index=True, help_text='LLM-generated task identifier for tracking and preventing duplicates', max_length=100, null=True, unique=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
            ],
            options={
